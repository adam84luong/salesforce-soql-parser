...
//		super("select id, (select id, createddate from campaignmembers order by createddate limit 1)  from campaign bla where recordtype.name like 'FDB %' and id in (select campaignid from campaignmember where createddate > n_days_ago:5)");
	}
